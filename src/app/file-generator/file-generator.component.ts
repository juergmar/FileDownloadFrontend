...
export class FileGeneratorComponent implements OnInit, OnDestroy {
    ...
    public onGenerateFile({ fileType, parameters }: { fileType: FileType; parameters?: Record<string, any> }): void {
        this.jobProcessingService.initiateJobProcessing(fileType, parameters);
    }
